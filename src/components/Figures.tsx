    ...
    <div className="container p-3">
        ...
        <div className="flex flex-col md:flex-row md:gap-48 gap-10 pt-16">
            ...
            <div className="max-w-xl min-w-xl md:min-w-xl">
                <img src="/old_deliverables/figure1.png" className="rounded-xl w-full"/>
            </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 pt-16">
            <div>
                ...
                <div className="max-w-xl pt-5 text-sm">
                    ...
                    <p>Includes Menu Creation, Map/Navigation Design, Character Design/Movement, Collision Detection,
                        Interior Design, Map Transitions, Integration</p>
                    <p>Dependencies: Requirement Collection</p>
                </div>
            </div>
            <div className="max-w-xl min-w-xl md:min-w-xl">
                <img src="/old_deliverables/figure2.png" className="rounded-xl w-full"/>
            </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 pt-16">
            <div>
                ...
                <div className="max-w-xl pt-5 text-sm">
                    ...
                    <p>Dependencies: Implementation, Website Creation, Architecture, Risk management, Method selection
                        and planning</p>
                </div>
            </div>
            <div className="max-w-xl min-w-xl md:min-w-xl">
                <img src="/old_deliverables/figure3.png" className="rounded-xl w-full"/>
            </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-52 pt-16">
            ...
            <div className="max-w-xl min-w-xl md:min-w-xl">
                <img src="/old_deliverables/client-interview.png" className="rounded-xl w-full"/>
            </div>
        </div>
        <div className="flex flex-col md:flex-row gap-10 md:gap-52 pt-16">
            <div>
                <p className="text-sm">Figure 5</p>
                <h3 className="text-xl md:text-2xl font-semibold">
                    Architecture
                </h3>
                <div className="max-w-xl text-sm">
                    <h2 className="text-xl">CRC Cards</h2>

                </div>
            </div>
            <div className="max-w-xl min-w-xl md:min-w-xl">
                <img src="/old_deliverables/CRC%20Cards.png" className="rounded-xl w-full"/>
            </div>
        </div>
